  ...
  const modalContent = (
    ...
    >
      <div className="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div
          ref={modalRef}
          className={`inline-block align-bottom sm:align-middle bg-white rounded-xl text-left overflow-hidden shadow-xl transform sm:my-8 w-full modal-content-animate ${getModalWidth()}`}
            ...
            <div className="flex items-center justify-between px-6 py-5 border-b border-gray-200">
              ...
              {showCloseButton && (
                <button
                  type="button"
                  onClick={onClose}
                  className="text-gray-500 hover:text-gray-700 focus:outline-none focus:ring-2 focus:ring-primary-600 focus:ring-offset-2 p-1 rounded-lg"
                >
